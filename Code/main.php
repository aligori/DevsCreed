...
<section id="hero2" class="d-flex align-items-center">
    <div class="container">
        <h1>Klinika Troplini</h1>
        <h2>Bringing Your World Into Focus</h2>
    </div>
</section><!-- End Hero -->
...
<main id="main">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        <h3>Improving Vision... Improving Life!!</h3>
                        <p>
                            Klinika Troplini is dedicated to improving the quality of our patients' vision and their lives.
                            When you visit our office, your eye health is our top priority.
                            We provide every single service for you eyesight
                        </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <h4>Unrivalled, personal treatment.</h4>
                                    <p>
                                        Our clinic was established by consultant eye surgeons,
                                        trained to the highest standards in corneal and refractive surgery.
                                        We aim to deliver personalised treatment without compromise.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                    <div class="icon-box">
                        ...
                        <h4><a href="">Glaucoma management</a></h4>
                        <p>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                    <div class="icon-box">
                        ...
                        <h4><a href="">Laser Vision Correction / Refractive Surgery</a></h4>
                        <p>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                    <div class="icon-box">
                        ...
                        <h4><a href="">Computer Vision Syndrome</a></h4>
                        <p>
    ...
    <section id="doctors" class="doctors">
        <div class="container">
            ...
            <div class="section-title">
                <h2>Doctors</h2>
                <p>Some of the best doctors in the field of ophthalmology are part of our team.</p>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="member d-flex align-items-start">
                        ...
                        <div class="member-info">
                            <h4>Walter White</h4>
                            <span>Ophthalmologist & Optician</span>
                            <div class="social">
    ...
    <section id="contact" class="contact">
        ...
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1781.9251382917748!2d19.445664551411078!3d41.31258518009722!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x134fda49a04aaa97%3A0xd4b575907da95d7e!2sKlinika%20Troplini!5e0!3m2!1sen!2s!4v1623085901049!5m2!1sen!2s" width=100% height="350px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
                ...
                <div class="col-lg-4">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Location:</h4>
                            <p>
                                Klinika Troplini mbrapa bashkise, Rruga Kolonel Tomson, Durrës
                            </p>
                        </div>
                        ...
                        <div class="email">
                            ...
                            <h4>Email:</h4>
                            <p>contact@klinikatroplini.al</p>
                        </div>
...
<footer id="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p>
                        Klinika Troplini, <br>
                        mbrapa bashkise,<br>
                        Rruga Kolonel Tomson, Durres<br><br>
                        <strong>Phone:</strong> +355 69 99 99 999<br>
                        <strong>Email:</strong> contact@klinikatroplini.al <br>
                    </p>
                </div>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bx bx-chevron-right"></i> <a href="#appointment">Book Now</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4 col-md-6 footer-newsletter">
                    ...
                    <p>Subscribe to receive the latest notification and offers about our products and services</p>
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="me-md-auto text-center text-md-start">
            <div class="copyright">
                &copy; Copyright <strong><span>Klinika Troplini</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
                Designed by <a href="https://github.com/aligori/DevsCreed">DevsCreed</a>
            </div>
        </div>
